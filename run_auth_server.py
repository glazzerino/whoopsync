...
"""
Run the OAuth2 authentication server for Whoop integration.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Run the Whoop OAuth2 authentication server")
...
def main():
    ...
    # Set environment variables for the auth server
    os.environ["WHOOP_CLIENT_ID"] = args.client_id
    os.environ["WHOOP_CLIENT_SECRET"] = args.client_secret
    os.environ["WHOOP_REDIRECT_URI"] = args.redirect_uri or f"http://{args.host}:{args.port}/auth/callback"
